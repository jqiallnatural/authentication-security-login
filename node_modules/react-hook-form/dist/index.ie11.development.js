...
function baseGet(object, path) {
    return __spread(Array(path.length)).reduce(function (result, _, i) { return result[path[i]] || result; }, object);
}
function unset(object, path) {
    var updatePath = isKey(path) ? [path] : stringToPath(path);
    var childObject = updatePath.length == 1 ? object : baseGet(object, updatePath.slice(0, -1));
...
function findRemovedFieldAndRemoveListener(fields, handleChange, field, unmountFieldsStateRef, shouldUnregister, forceDelete) {
    ...
    var fieldRef = fields[name];
    if (!shouldUnregister) {
        var value = getFieldValue(fields, name);
...
var getFieldsValues = (function (fields, search) {
    ...
    var _loop_1 = function (name_1) {
        if (isUndefined(search) ||
            ...
            output[name_1] = getFieldValue(fields, name_1);
        }
    };
...
function useForm(_a) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, validateField(fieldsRef, validateAllFieldCriteria, fieldsRef.current[name])];
                case 1:
                    error = _a.sent();
    ...
    var executeSchemaOrResolverValidation = React.useCallback(function (payload) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, resolverRef.current(getFieldValueByName(fieldsRef.current), contextRef.current, validateAllFieldCriteria)];
                case 1:
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, resolver(getFieldValueByName(fieldsRef.current), contextRef.current, validateAllFieldCriteria)];
                        case 1:
    ...
    var validateResolver = React.useCallback(function (values) {
        ...
        resolverRef.current(transformToNestObject(__assign(__assign({}, fieldValues), values)), contextRef.current, validateAllFieldCriteria).then(function (_a) {
    ...
    function registerFieldsRef(ref, validateOptions) {
        ...
        fields[name] = field;
        var isEmptyUnmountFields = isUndefined(unmountFieldsStateRef.current[name]);
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    fieldErrors = {};
                    fieldValues = __assign(__assign({}, unmountFieldsStateRef.current), getFieldsValues(fieldsRef.current));
                ...
                case 1:
                    ...
                    return [4 /*yield*/, resolverRef.current(transformToNestObject(fieldValues), contextRef.current, validateAllFieldCriteria)];
                case 2:
    ...
    var getValue = function (name) { return getFieldValue(fieldsRef.current, name); };
...
var useFieldArray = function (_a) {
    ...
    var prepend$1 = function (value, shouldFocus) {
        ...
        if (isArray(errorsRef.current[name])) {
            errorsRef.current[name] = prepend(errorsRef.current[name], emptyArray);
        }
    ...
    var insert$1 = function (index, value, shouldFocus) {
        ...
        if (isArray(errorsRef.current[name])) {
            errorsRef.current[name] = insert(errorsRef.current[name], index, emptyArray);
        }
        if (readFormStateRef.current.touched && touchedFieldsRef.current[name]) {
...
var Controller = function (_a) {
    ...
    var getInitialValue = function () {
        return !isUndefined(unmountFieldsStateRef.current[name]) && isNotFieldArray
            ? unmountFieldsStateRef.current[name]
